...
const Index = ({darkMode}) => {
    const handleShare = async () => {
        const message = 'Эпилепсия-хроническое неврологическое заболевание, вызванное нарушениями работы головного мозга из-за чрезмерной электрической активности нейронов и сопровождающееся периодически возникающими припадками.\n' +
            '\n' +
            '\n' +
            ...
            '•\tУложить пациента на плоскую поверхность и уложить на бок-чтобы слюна свободно вытекала из полости рта и не мешала дыханию, и обеспечить аккуратную фиксацию в данном положении;\n' +
            ...
            'Если есть возможность, то засеките сколько длится приступ. Можно снять приступ на видео-это очень поможет врачу неврологу поставить диагноз, если приступ случился первый раз.\n' +
