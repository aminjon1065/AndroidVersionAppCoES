...
const Index = ({darkMode}) => {
    const handleShare = async () => {
        const message = 'ОБМОРОЖЕНИЯ.\n' +
            ...
            '- I степень - наиболее легкая, после согревания на участке обморожения развивается отек, кожа становится синюшной; \n' +
            ...
            'Симптомы: - чувство холода; - покалывание в обмораживаемой части тела; - затем – онемение и потеря чувствительности. \n' +
